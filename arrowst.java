...
/**
 * Write a description of class arrowst here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class arrowst extends arrow
{
    /**
     * Act - do whatever the arrowst wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if(leftCollision()==true || isAtEdge()==true)
            getWorld().removeObject(actor);
        else if(playerSideCollision() == 1){//verifica coliziunea in stanga cu un jucator
